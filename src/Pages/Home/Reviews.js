    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 p-2">
        {ratings?.slice(0, 6)?.map(rating => (
          <Review key={rating._id} rating={rating} check1={check1} check2={check2} check3={check3} check4={check4} check5={check5} setCheck1={setCheck1} setCheck2={setCheck2} setCheck3={setCheck3} setCheck4={setCheck4} setCheck5={setCheck5} />
        ))}
      </div>
    </div>
  );
